function FindDifference(nums: number[], target: number): number[] {
    const map = new Map<number, number>(); // Храним числа и их индексы
...
console.log(FindDifference([1, 5, 9, 3], 4)); // [0, 1], так как 5 - 1 = 4
